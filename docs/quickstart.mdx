...
<Steps>
  <Step title="Install cac">
    ...
    If you synced this repo to another machine and need to install your **local modified code**, use the `Local repo` tab from the repo root. The installer will build the local tree first, then install that exact result.
...
<Columns cols={2}>
  <Card title="Local repo install" icon="server" href="/guides/local-repo-install">
    Install your synced/customized repo with one script.
  </Card>
